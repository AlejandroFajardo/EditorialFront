...
@Component({
  selector: 'app-centro-asistente-dashboard',
  templateUrl: './centro-asistente-dashboard.component.html',
  styleUrls: ['./centro-asistente-dashboard.component.scss']
})
export class CentroAsistenteDashboardComponent implements OnInit { 
  userData: any;
  userIsAdmin = false;
