...
@Component({
  selector: 'app-centro-jefe-dashboard',
  templateUrl: './centro-jefe-dashboard.component.html',
  styleUrls: ['./centro-jefe-dashboard.component.scss']
})
export class CentroJefelDashboardComponent implements OnInit {
  userData: any;
  userIsAdmin = false;
